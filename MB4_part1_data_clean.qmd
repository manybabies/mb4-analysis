...
participant_summaries <- participant_summaries |> 
  mutate(ex_not_eligible = meet_eligibility != "Y",
         # approximate age range limits: 5m 15d to 10m 15d
         ex_out_of_age_range = age_days > 330 | age_days < 150,
...
summary_by_lab <- merge(summary_by_lab_sample, summary_by_lab_age, by = "lab_id", all.x = TRUE)
...
exclusion <- summary_by_lab[, c("lab_id", "exclusion_rate")]
