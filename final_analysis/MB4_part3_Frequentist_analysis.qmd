...
# Adding the condition:z_age_days interaction does not improve model fit.
```
...
# no effect of age in the nonsocial condition
```
...
# Main effect of condition and condition:age interaction
```
...
# Effect of condition and nearly significant effect of the interaction between condition and age - but needed to remove correlation between random effects for convergence
```
